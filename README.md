...
- 🎯 **Tombol Rapat** — satu kotak tick spacing yang mencakup harga: posisi langsung aktif dan langsung makan fee, dua sisi (sisi meme dibeli otomatis). Serapat yang diizinkan pool. Kartu konfirmasi menyebut presisi kisinya (pool fee 5% biasanya 10,5%; fee 0,05% sekitar 0,1%)
